...
module.exports = function () {
	...
	// Bulk queue actions
	setupApiRoute(router, 'post', '/queue/bulk/accept', controllers.write.posts.acceptQueuedPostsBulk);
	setupApiRoute(router, 'delete', '/queue/bulk', controllers.write.posts.removeQueuedPostsBulk);
