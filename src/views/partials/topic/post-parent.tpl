<div component="post/parent" data-collapsed="true" data-parent-pid="{./parent.pid}" data-uid="{./parent.uid}" class="btn btn-ghost btn-sm d-flex gap-2 text-start flex-row mb-2" style="font-size: 13px;">
	<div class="d-flex gap-2 text-nowrap">
		<div class="d-flex flex-nowrap gap-1 align-items-center">
			{{{ if ./parent.anonymous }}}
			<span class="text-decoration-none lh-1">{buildAvatar({"uid":0,"username":"[[global:anonymous]]","userslug":"","displayname":"[[global:anonymous]]","picture":"","anonymous":true}, "16px", true, "not-responsive align-middle")}</span>
			<span class="fw-semibold text-truncate" style="max-width: 150px;">[[global:anonymous]]</span>
			{{{ else }}}
