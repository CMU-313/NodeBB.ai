<div id="post-tooltip" class="card card-body shadow bg-body text-body z-1 position-absolute">
    <div class="d-flex flex-column gap-2">
        <div class="d-flex gap-2 align-items-center">
            <div>
                {{{ if post.anonymous }}}
                <span>{buildAvatar({"uid":0,"username":"[[global:anonymous]]","userslug":"","displayname":"[[global:anonymous]]","picture":"","anonymous":true}, "20px", true, "", "user/picture")}</span>
                <span>[[global:anonymous]]</span>
                {{{ else }}}
