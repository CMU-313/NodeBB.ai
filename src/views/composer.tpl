	...
	<div class="composer-container d-flex flex-column gap-1 h-100">
		...
		<div class="p-2 d-flex flex-column gap-1 h-100">
			...
			<div class="form-check mb-2">
				<input class="form-check-input" type="checkbox" id="anonymous-posting-checkbox" name="isAnonymous">
				<label class="form-check-label" for="anonymous-posting-checkbox">
					[[topic:composer.post-anonymously]]
				</label>
				<p class="form-text text-muted small">[[topic:composer.post-anonymously-help]]</p>
			</div>
			{{{ end }}}
